...
/** A horizontal 0..1 gradient PPMX — useful for colormap assertions. */
export function gradientPpmx(width = 8, height = 4): Buffer {
  return makePpmx(width, height, (x) => x / (width - 1));
}
